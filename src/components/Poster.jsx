         ...
         >
            ...
            >
                ...
                >
                    ...
                    <div className="absolute left-0 right-0 bottom-0 p-3 bg-gradient-to-t from-black/90 via-black/70 to-transparent">
                        <h4 className="text-sm font-bold text-white truncate mb-1" title={displayTitle}>{renderHighlighted(displayTitle)}</h4>
                    ...
                    {/* Watched Checkmark */}
                    {isWatched && (
                        <div className="absolute top-2 right-2 w-6 h-6 bg-red-600 rounded-full flex items-center justify-center text-white z-30 shadow-lg" title="Watched">
                    ...
                    {/* --- HOVER OVERLAY --- */}
                    <div
                        className={`absolute inset-0 bg-gradient-to-t from-black via-black/90 to-transparent p-3 transition-all duration-300 ease-in-out z-30 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto ${
                        ...
                        {showPreview && previewKey && (
                            <div className="absolute inset-0 z-10 pointer-events-none">
                                <ReactPlayer
                                    ...
                                    width="100%"
                                    height="100%"
                                    style={{ objectFit: 'cover', filter: 'brightness(0.6)', transform: 'scale(1.05)', position: 'absolute', inset: 0 }}
                                    config={{ youtube: { playerVars: { controls: 0, disablekb: 1, modestbranding: 1, rel: 0 } } }}
                                />
                            </div>
                        )}
                        {/* Play/Info Buttons */}
                ...
                <div className="pt-2 pb-2 px-2 bg-transparent">
                    <h3
                        className="text-sm font-semibold text-[var(--text-primary)] transition-colors duration-200 truncate group-hover:text-white"
                        title={displayTitle}
                    >
