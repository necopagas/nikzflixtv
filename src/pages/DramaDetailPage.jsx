...
export const DramaDetailPage = () => {
  ...
  return (
    <div className="px-4 sm:px-8 md:px-16 pt-28 pb-20">
        ...
        <div className="md:w-2/3">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {drama.genres?.map(genre => (
              <span key={genre} className="bg-(--bg-tertiary) text-sm px-3 py-1 rounded-full">
                {genre}
              </span>
            ))}
          </div>
      ...
      {/* <div className="mt-12">
                 <h2 className="text-3xl font-bold mb-6 border-b border-(--border-color) pb-2">Episodes</h2>
                 <p className="text-(--text-secondary)">Episodes can be viewed by clicking the poster on the main Drama page.</p> 
            </div> 
            */}
    </div>
  );
