  ...
  return (
    <div className="px-4 sm:px-8 md:px-16 pt-28 pb-20">
      <div className="max-w-4xl mx-auto">
        {isLoading ? (
          <div className="aspect-video w-full bg-(--bg-secondary) flex items-center justify-center rounded-lg">
            <div className="player-loading"></div>
          </div>
        ) : error ? (
          <div className="aspect-video w-full bg-(--bg-secondary) flex items-center justify-center rounded-lg text-center">
          ...
          <EnhancedVideoPlayer
            ...
            onEnded={() => {
              try {
                ...
                console.warn('Failed to mark watched:', err);
              }
            }}
            autoplay={true}
