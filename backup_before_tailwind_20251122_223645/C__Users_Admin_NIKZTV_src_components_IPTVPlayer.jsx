            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 ml-2">
                ...
                <input
                  ...
                  className="w-24 focus:outline-none focus:ring-2 focus:ring-[var(--brand-color)]"
                />
              </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              {qualities.length > 1 && (
                <button
                  ...
                  className="px-3 py-1 bg-white/20 hover:bg-white/30 rounded text-sm focus:outline-none focus:ring-2 focus:ring-[var(--brand-color)]"
                >
                  {currentQuality}{' '}
                  ...
                  <div className="absolute right-0 bottom-10 bg-black/90 rounded p-2">
                    {[0.5, 0.75, 1, 1.25, 1.5, 2].map(rate => (
                      <button
                        ...
                        className={`block w-full text-left px-3 py-1 text-sm hover:bg-white/20 ${playbackRate === rate ? 'text-[var(--brand-color)] font-bold' : ''}`}
                      >
                        {rate}x
                      </button>
                    ))}
              ...
              <button
                ...
                className={`p-2 rounded-full bg-black/50 hover:bg-white/20 transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--brand-color)] ${captionsEnabled ? 'text-[var(--brand-color)]' : ''}`}
                ...
                <button
                  ...
                  className={`block w-full text-left px-3 py-2 rounded hover:bg-white/20 text-sm transition-colors ${
                    ...
                    (currentQuality === 'Auto' && q.value === -1)
                      ? 'text-[var(--brand-color)] font-bold'
                      : ''
                  }`}
                >
                  {q.label}
      ...
      {isMobile && (
        <div className="absolute bottom-3 left-1/2 transform -translate-x-1/2 z-30 bg-black/60 rounded-full px-3 py-2 flex items-center gap-3 backdrop-blur-md">
          <button
            onClick={() => seek(-10)}
            aria-label="Rewind 10 seconds"
            className="p-2 rounded-full bg-black/40 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-[var(--brand-color)]"
          >
            <FaBackward />
          </button>
          <button
            ...
            aria-pressed={isPlaying}
            aria-label={isPlaying ? 'Pause' : 'Play'}
            className="p-3 rounded-full bg-[var(--brand-color)] text-black focus:outline-none focus:ring-2 focus:ring-white"
          >
            {isPlaying ? <FaPause /> : <FaPlay />}
          </button>
          <button
