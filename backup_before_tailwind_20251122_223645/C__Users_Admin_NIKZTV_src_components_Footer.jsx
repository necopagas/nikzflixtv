...
export const Footer = () => {
  return (
    <footer className="bg-transparent text-center py-6 mt-12 border-t border-(--border-color)">
      ...
      <p className="text-xs text-(--text-secondary) mt-2">
        This site does not store any files on our server, we only link to the media which is hosted
