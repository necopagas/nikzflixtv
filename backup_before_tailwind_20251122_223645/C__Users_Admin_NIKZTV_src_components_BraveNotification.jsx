...
export const BraveNotification = () => {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-[9999] max-w-sm animate-slide-in-right">
            <div className="bg-gradient-to-br from-orange-600 to-orange-800 text-white rounded-xl shadow-2xl p-5 border-2 border-orange-400">
                {/* Close Button */}
                <button
                ...
                <div className="flex items-start gap-4 pr-6">
                    ...
                    <div className="flex-1">
                        <h3 className="font-bold text-lg mb-2">
                            🦁 Dili ka gusto sa Ads?
                        </h3>
                        <p className="text-sm text-orange-100 mb-4 leading-relaxed">
                            Gamita ang <strong>Brave Browser</strong> para ma-block ang tanan nga ads! 
                            Faster, secure, ug walay distractions. 🚀🛡️
                        </p>
